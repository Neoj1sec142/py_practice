...
from .serializers import UserSerializer, ProfileSerializer, GetProfileSerializer, PostSerializer, GetPostSerializer, CommentSerializer
...
class PostView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save(user=request.user, name=request.user.name)
